...
const ClassReloadPlugin = require("reload-html-webpack-plugin")
...
const oWpackConfig = {
    ...
    //file to compile
    entry : oPath.resolve("./jspatterns.html"),
    //compiled result file. bundle.js
    output : {
        path: oPath.resolve("./webpack/compiled"),
        publicPath: "./webpack/compiled/",//le indica a webpack donde guardara en memoria lo compilado
        filename : "bundle.js"
    },
    ...
    plugins : isDebugMode ? [] : [
        ...
        new ClassReloadPlugin(),
    ],

    //configuración para webpack-dev-server
    devServer:{
        contentBase: oPath.resolve("../"),
        compress: true,
        port:9000
    }
